...
public class Collection extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		GridView gridview=(GridView)findViewById(R.id.collect_gridview);//找到main.xml中定义gridview 的id      
		...
		gridview.setOnItemClickListener(new OnItemClickListener(){//监听事件    
			...
			{       
				//Toast.makeText(Collection.this, ""+position,Toast.LENGTH_SHORT).show();//显示信息;     
				Intent intent =new Intent();
				intent.setClass(Collection.this, Collect_OneAlbum.class);
