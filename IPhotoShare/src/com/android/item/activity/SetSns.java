	...
	public void onCreate(Bundle savedInstanceState) {
		...
		okbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Toast.makeText(SetSns.this, "提示绑定是否成功",Toast.LENGTH_SHORT).show();
			}
		});
		...
		// 给CheckBox设置事件监听
		renren.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			@Override
		...
		sina.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton buttonView,
					boolean isChecked) {
				// TODO Auto-generated method stub
		...
		tengxun.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton buttonView,
					boolean isChecked) {
				// TODO Auto-generated method stub
