...
public class PhotoDrawerTemp extends Activity implements
	...
	boolean rec = false, circle = false, oval = false, line = false,
			rays = false, fill_p = true, stroke_p = false, shader_p = false;// ���ƶ����
	boolean derectx = false;// eback,ʹ����Ƥ����true�����ƻ�����ɫ�ָ���derectx���ֻ���Ϊ����ʱΪtrue
	Pic pic;
	static int count = -1, colorC = 0;// �ж϶��������
	...
	public class Pic extends View {
		...
		private void onTouchUp(float x, float y) {
			...
			if ((painterBoo) && (!eraserBoo) && (!shapeBoo) && (!colorBoo)) {
				...
				temptCanvas.drawPath(mPath, mPaint);// ��ָ�뿪��Ļ�󣬻��ƴ����ġ����С�·����
