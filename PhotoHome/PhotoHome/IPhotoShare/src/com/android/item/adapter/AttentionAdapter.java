...
public class AttentionAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (Login_Reg.theme_num == 1){
			view = View.inflate(mContext, R.layout.attention_list_item2, null);
		}else{
			view = View.inflate(mContext, R.layout.attention_list_item, null);
		}
		...
		user_head.setImageResource(ua.getHeadRes());
