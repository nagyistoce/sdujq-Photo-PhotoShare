...
public class Upload extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		okbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				uation.savePhoto(BitmapFactory
						.decodeFile("/mnt/sdcard/temp100.jpg"), title.getText()
						.toString(), info.getText().toString());
	...
	private void do_apn() {
		new AsyncTask<Void, Void, String>() {
			...
			protected String doInBackground(Void... params) {
				...
				try {
					location = new AddressTask(Upload.this, AddressTask.DO_APN)
							.doApnPost();
				} catch (Exception e) {
					e.printStackTrace();
				}
		...
		new AsyncTask<Void, Void, String>() {
			...
			protected String doInBackground(Void... params) {
				...
				try {
					...
					location = new AddressTask(Upload.this, AddressTask.DO_GPS)
							.doGpsPost(gpsdata.getLatitude(), gpsdata
									.getLongitude());
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	private void do_wifi() {
		new AsyncTask<Void, Void, String>() {
			...
			protected String doInBackground(Void... params) {
				MLocation location = null;
				try {
					location = new AddressTask(Upload.this, AddressTask.DO_WIFI)
							.doWifiPost();
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	private void doUptoSina() {
		try {
			sina.share2weibo(Upload.this, sina.getAccessToken().getToken(),
					sina.getAccessToken().getSecret(), "来自TimeCapture",
	...
	public void toRenren(File f) {
		Renren renren = new Renren("a8b3c9a32d1349f193eb67d39146f1c0",
				"dbead8eeefa747e180a00e288ca6fa1e", "197692", Upload.this);
		...
		if (requestCode == 13578) {
			if (resultCode == OAuthV2AuthorizeWebView.RESULT_CODE) {
				...
				try {
					...
					t.addPic(oAuth, "xml", "来自TimeCapture", "211.87.227.56",
							"/mnt/sdcard/temp100.jpg");
				} catch (Exception e) {
					e.printStackTrace();
				}
